...
class Day1WelcomeLetterWindow: ProPromptWindow {
    ...
    convenience init(forceFreshInstall: Bool? = nil) {
        ...
        let messageText = isFresh
            ? NSLocalizedString("AltTab is a free, open-source window switcher for macOS. Pro features are available FOREVER!", comment: "")
            : NSLocalizedString("Enhoy pro!", comment: "")
